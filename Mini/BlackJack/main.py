...
def deal_card():
    """Take a list of card and return the score calculated form the cards"""
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
#         return "Draw"
#     elif computer_score == 0:
#         return "Lose. Opponent hsa Balckjack"
#     elif user_score == 0:
#         return "Win with a Blackjack"
#     elif user_score > 21:
#         return "U went over. U lose"
#     elif user_score > computer_score :
#         return "U win"
#     else:
#         return "U lose"
...
#Hint 5: Deal the user and computer 2 cards each using deal_card() and append().
    ...
    while not is_game_over:
        ...
        print(f" U cards: {user_cards}, current score:{user_score}")
